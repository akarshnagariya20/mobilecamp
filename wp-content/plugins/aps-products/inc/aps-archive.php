	...
	<div class="aps-container">
		<div class="aps-row clearfix">
			<div class="aps-content aps-content-<?php echo $design['content']; ?>">
				...
				$term = get_term_by('slug', $brand, 'aps-brands');
				...
				<h1 class="aps-main-title"><?php echo str_replace('%brand%', $term->name, $settings['brands-title']); ?></h1>
				
				<?php // get compare page link
				$comp_link = get_compare_page_link(); 
				
				// get and display brand description
				$brand_desc = term_description($term->term_id, 'aps-brands');
				
				if (!empty($brand_desc)) { ?>
					<div class="aps-brand-desc aps-column"><?php echo $brand_desc; ?></div>
				<?php } ?>
				...
				<div class="aps-column">
					...
					<div class="aps-brands-controls aps-dropdown">
						...
						if ($brands) { ?>
							<span class="aps-current-dp"><?php echo $term->name; ?></span>
							<ul>
								<?php foreach ($brands as $brand) {
									if ($term->term_id != $brand->term_id) { ?>
							...
							<li>
								<div class="aps-product-box">
									...
									<span class="aps-product-thumb">
										<a class="aps-btn-boxed aps-add-compare" href="#" data-pid="<?php echo $post->ID; ?>" data-msg="<?php echo '<strong>' .__('Success', 'aps-text') .':</strong> ' .__('You have added', 'aps-text') .' <strong>' .$title .'</strong> ' .__('to your', 'aps-text') .' <a href=\'' .$comp_link .'\'>' .__('comparison list', 'aps-text') .'</a>'; ?>" title="<?php _e('Add to Compare', 'aps-text'); ?>"><img src="<?php echo $thumb['url']; ?>" width="400" height="400" alt="<?php the_title_attribute(); ?>" /><span class="hover-effect"><i>&nbsp; </i></a>
									</span>
